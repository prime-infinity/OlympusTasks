...
const DashSideBar = () => {
    console.log("sidebar supposed to be in lap");
    return(
        <div>
                ...
                <div className="container-fluid d-flex flex-column p-0">
                    <ul className="navbar-nav text-light ul-fixed" id="accordionSidebar">
                        <li className="nav-item pb-5 mobile-bottom-nav__item-content">
                            <svg className="footer-icon-selected text-muted-native" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20" fill="none" style={{fontSize: '28px'}}>
                        ...
                        <li className="nav-item pb-5 mobile-bottom-nav__item-content">
                            <i className="typcn typcn-th-large text-muted-native" style={{fontSize: '28px'}}></i>
                        </li>
                        <li className="nav-item pb-5 mobile-bottom-nav__item-content">
                            <svg xmlns="http://www.w3.org/2000/svg" className="text-muted-native" width="1em" height="1em" viewBox="0 0 20 20" fill="none" style={{fontSize: '28px'}}>
                        ...
                        <li className="nav-item pb-5 mobile-bottom-nav__item-content">
                            <i className="typcn typcn-plus text-muted-native" style={{fontSize: '28px'}}></i>
                        </li>
                    </ul>
                </div>
            </nav>
