                ...
                <div className="container-fluid d-flex flex-column p-0">
                    <ul className="navbar-nav text-light ul-fixed" id="accordionSidebar">
                        <li className="nav-item pb-5 mobile-bottom-nav__item-content">
                            <svg onClick={() => dispatch(setMenu(0))} className={`text-muted-native ${menuState === 0 ? "footer-icon-selected": ""}`} xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20" fill="none" style={{fontSize: '28px'}}>
                        ...
                        <li className="nav-item pb-5 mobile-bottom-nav__item-content">
                            <svg xmlns="http://www.w3.org/2000/svg" onClick={() => dispatch(setMenu(1))} className={` text-muted-native ${menuState === 1 ? "footer-icon-selected": ""} `} style={{fontSize: '28px'}} width="1em" height="1em" viewBox="0 0 20 20" fill="currentColor">
                                <path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                            </svg>
                        </li>

                        <li className="nav-item pb-5 mobile-bottom-nav__item-content">
                            <svg xmlns="http://www.w3.org/2000/svg" onClick={() => dispatch(setMenu(3))} className={` text-muted-native ${menuState === 3 ? "footer-icon-selected": ""} `} style={{fontSize: '28px'}} width="1em" height="1em" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                            </svg>
                        </li>

                        <li className="nav-item pb-5 mobile-bottom-nav__item-content">
                            <svg onClick={() => dispatch(setMenu(2))} xmlns="http://www.w3.org/2000/svg" className={` text-muted-native  ${menuState === 2 ? "footer-icon-selected": ""} `} width="1em" height="1em" viewBox="0 0 20 20" fill="none" style={{fontSize: '28px'}}>
