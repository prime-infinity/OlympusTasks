            ...
            <nav className="navbar d-md-block navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style={{height:'2500px'}}>
                <div className="container-fluid d-flex flex-column p-0">
                    <ul className="navbar-nav text-light ul-fixed" id="accordionSidebar">
                        ...
                        <li className="nav-item pb-5 mobile-bottom-nav__item-content">
                            <i onClick={() => dispatch(setMenu(1))} className={`typcn typcn-th-large text-muted-native ${menuState === 1 ? "footer-icon-selected": ""} `} style={{fontSize: '28px'}}></i>
                        </li>
                        <li className="nav-item pb-5 mobile-bottom-nav__item-content">
                            <i onClick={() => dispatch(setMenu(3))} className={` typcn typcn-plus text-muted-native ${menuState === 3 ? "footer-icon-selected": ""} `} style={{fontSize: '28px'}}></i>
                        </li>
                        <li className="nav-item pb-5 mobile-bottom-nav__item-content">
