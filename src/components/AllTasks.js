...
const AllTasks = () => {
    ...
    return(
        ...
        <div className="row">
            ...
            <div className="col-12 col-md-6 mb-5" key={i}>
                ...
                <div className="card bg-card-theme py-2 text-muted">
                    ...
                    <div className="card-header">
                        ...
                        <div className="row">
                            ...
                            <div className="col-8 text-theme">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" cwidth="1em" height="1em" viewBox="0 0 20 20" fill="currentColor" style={{fontSize: '25px'}}>
