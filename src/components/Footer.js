        ...
        <div className="mobile-bottom-nav d-md-none" style={{paddingBottom:'8%'}}>
            ...
            <div className="mobile-bottom-nav__item">
                <div className="mobile-bottom-nav__item-content">
                    <svg className="footer-icon-selected" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20" fill="none" style={{fontSize: '35px'}}>
            ...
            <div className="mobile-bottom-nav__item">
                <div className="mobile-bottom-nav__item-content">
                    <i className="typcn typcn-th-large" style={{fontSize: '35px'}}></i>
                </div>		
            </div>

            <div className="mobile-bottom-nav__item">
                <div className="mobile-bottom-nav__item-content">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20" fill="none" style={{fontSize: '35px'}}>
            ...
            <div className="mobile-bottom-nav__item">
                <div className="mobile-bottom-nav__item-content">
                    <i className="typcn typcn-plus" style={{fontSize: '35px'}}></i>
                </div>		
            </div>
